...
# This section fixes the "Unnamed_HUR..." stuff into a human redable format
s/Unnamed_1HUR1994/Unnamed_1HUR1944/
s/Unnamed_1[A-Za-z]*[0-9][0-9]*[_]*\([A-Za-z0-9]*\)/1st Hurr \1/
s/Unnamed_2[A-Za-z]*[0-9][0-9]*[_]*\([A-Za-z0-9]*\)/2nd Hurr \1/
s/Unnamed_3[A-Za-z]*[0-9][0-9]*[_]*\([A-Za-z0-9]*\)/3rd Hurr \1/
s/Unnamed_\([4-9][0-9]*\)[A-Za-z]*[0-9][0-9]*[_]*\([A-Za-z0-9]*\)/\1th Hurr \2/
